...
`;
        ...
        const onPointerMove = (e: any) => {
            ...
            if (window.matchMedia('(prefers-reduced-motion: reduce)').matches && programRef.current && meshRef.current) {
        ...
        const loop = (t: any) => {
            ...
            if (!paused && programRef.current && meshRef.current && !prefersReducedMotion) {
                try {
                    renderer.render({ scene: meshRef.current });
                } catch (e) {
                    console.error(e);
