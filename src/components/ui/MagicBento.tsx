...
export const ParticleCard = ({
    ...
    // Merge provided className with internal MagicBento classes
    // If user provides a className, it appends. We also ensure magic-bento-card base class is present if needed, 
    // though ParticleCard is generic. The CSS expects .magic-bento-card for some styles.
    const combinedClassName = `magic-bento-card ${className} particle-container`;
...
export const GlobalSpotlight = ({
    ...
    `;
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            // We look for closest bento-section or just assume gridRef is the container
...
// Default export if you want to use it as a complete component
const MagicBento = ({
    cards = [],
    textAutoHide = true,
    enableStars = true,
        ...
        <>
            ...
            <div className="card-grid bento-section" ref={gridRef}>
                {cards.map((card, index) => {
                    ...
                    // Non-particle version (simplified for brevity, we can assume particle card is primary)
                    return (
                        <ParticleCard
                            key={index}
                            className={baseClassName}
